-- Migration: Decoupled Affiliate Schema Architecture

-- 1. Create affiliate_links relational table
CREATE TABLE IF NOT EXISTS public.affiliate_links (
    ...
    program_name TEXT,
    affiliate_url TEXT,
    status TEXT DEFAULT 'DISCOVERY_REQUIRED',
...
-- 2. Create affiliate_candidates queue table
CREATE TABLE IF NOT EXISTS public.affiliate_candidates (
    ...
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT unique_candidate_url UNIQUE (tool_id, candidate_url)
);

-- 3. Create affiliate_clicks telemetry table
...
-- 4. Create affiliate_settings table for publisher credentials
