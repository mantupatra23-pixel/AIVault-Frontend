...
import ToolIntelligencePanel from "@/components/tool-intelligence/ToolIntelligencePanel";
...
export async function generateMetadata({
  ...
  return {
    ...
    description: getSeoDescription(tool),
...
export default async function ToolPage({
  ...
  const tool = await getToolBySlug(requestedSlug);

  /*
   * Never show another tool when the requested
   * slug does not exist.
   */
  if (!tool) {
    notFound();
  ...
  /* =======================================================
     EXISTING AI VAULT DATA HELPERS
  ======================================================= */
  ...
  const overview = getOverview(tool);

  const features = getFeatures(tool);

  const useCases = getUseCases(tool);

  const limitations = getLimitations(tool);
  ...
  /* =======================================================
     LAYER 1 DATA
     Reuse existing AI Vault backend/data.
  ======================================================= */
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-7 sm:px-6 sm:py-10 lg:px-8">
        ...
        <section className="mt-10">
          ...
          <div className="mb-5">
            ...
            <div className="inline-flex rounded-full bg-blue-50 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-blue-600">
              Layer 1
            </div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
              Understand this AI tool through features, use cases,
              pricing, platforms, and verified product information.
            </p>
        ...
        <section className="mt-10 rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-7">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Visit the official platform for current product
        ...
        <section className="mt-10">
          ...
          {integrations.length ? (
            ...
            <p className="mt-4 text-sm text-slate-500">
              Integration information has not been specified by
              the source.
            </p>
          )}
        ...
        <section className="mt-10 rounded-3xl bg-slate-950 px-6 py-12 text-center text-white sm:px-10">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-slate-300">
            Visit the official platform to verify the latest
            product information.
          </p>
