...
export default function Home() {
  ...
  return (<div className="bg-[#fcfcfc] min-h-screen font-sans">
      <header className="max-w-6xl mx-auto px-6 pt-24 pb-12 text-center">
        ...
        <p className="text-xl text-gray-400 font-medium mb-12">Handcrafted by Mantu Patra.</p>

        <div className="max-w-2xl mx-auto mb-12 relative">
          <input
            type="text"
            placeholder="Search AI tools..."
            className="w-full px-8 py-6 rounded-3xl border-2 border-gray-100 focus:border-blue-600 outline-none text-xl font-medium shadow-sm transition-all"
            value={search}
